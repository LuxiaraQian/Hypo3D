...
def collect_requests(filename, system_content, prompt, split_ratio=5):
    ...
    for scene_id, changes_list in preprocess_data.items():
        if scene_id.startswith('scene'):
            ...
            scene_description = random.sample(scene_description, k=min(30, len(scene_description)))
        ...
        for changes in changes_list:
            ...
            for qa in question_answers:
                ...
                text_prompt = prompt.format(scene_description, scene_orientation, context_change, question)
...
def extract_data(total_number_of_files, filename, output_file='GPT_responses.json'):
                ...
                try:
                    ...
                    if count < len(ids):
                        ...
                        data.append({
                            ...
                            "prediction answer": completion_content,
                        })
...
if __name__ == '__main__':
    ...
    Next, given a context change, imagine how the scene would look after the change has been applied. Then, answer a question based on the changed scene.
